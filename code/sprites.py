...
class Paddle(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        pygame.draw.rect(self.shadow, COLORS["paddle shadow"], pygame.FRect((0,0), SIZE["paddle"]), 0, 10)
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, groups, paddle_sprites, update_score):
        ...
        self.shadow = self.image.copy()
        pygame.draw.circle(self.shadow, COLORS["ball shadow"], (SIZE["ball"][0] / 2, SIZE["ball"][1] / 2), SIZE["ball"][0] / 2)
    ...
    def move(self, dt):
        self.rect.x += self.direction.x * SPEED["ball"] * dt * self.speed_mod
        self.collision("horizontal")
        self.rect.y += self.direction.y * SPEED["ball"] * dt * self.speed_mod
